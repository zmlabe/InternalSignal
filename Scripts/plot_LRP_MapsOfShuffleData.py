"""
Plots LRP maps of uncertainty for SHUFFLED data
...
### Read in LRP maps
data = Dataset(directorydata + 'LRP_Maps_%s_20ens_%s_%s_SHUFFLE.nc' % (SAMPLEQ,variables[0],seasons[0]))
...
plt.savefig(directoryfigure + 'LRPstats_SHUFFLEDATA_%s_%s_%s.png' % (variables[0],
                                                        seasons[0],
                                                        SAMPLEQ),
                                                        dpi=300)