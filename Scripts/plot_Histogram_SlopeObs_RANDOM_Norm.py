"""
Plots normalized histograms of slope of observations using randomized data ANN
...
n, bins, patches = plt.hist(slopes,bins=np.arange(-1,1.21,0.1)-0.05,
                                        density=False,alpha=1,
                                        label=r'\textbf{RANDOM DATA ANN}',
...
plt.savefig(directoryfigure + 'Histogram_Slopes_RANDOM_T2M_%s_Norm.png' % SAMPLEQ,
            dpi=300)