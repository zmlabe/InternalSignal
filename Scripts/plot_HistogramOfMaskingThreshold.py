...
### Read in LRP maps
data = Dataset(directorydata + 'LRP_Maps_%s_20ens_%s_%s_SHUFFLE-SPACE.nc' % (SAMPLEQ,variables[0],seasons[0]))
...
meanall = lrp.ravel()
thresh = np.percentile(meanall,90)
...
plt.axvline(x=thresh,color=cm.classic_16.mpl_colormap(0.57),linewidth=2,linestyle='--',dashes=(1,0.3),
            zorder=10,label=r'\textbf{THRESHOLD TO MASK DATA - 90th percentile}')
...
plt.savefig(directoryfigure + 'LRPstats_ThresholdHistONLY_%s_%s_%s.png' % (variables[0],
                                                        seasons[0],
                                                        SAMPLEQ),
                                                        dpi=300)
...
plt.savefig(directoryfigure + 'LRPstats_ThresholdHistMap_%s_%s_%s.png' % (variables[0],
                                                        seasons[0],
                                                        SAMPLEQ),
                                                        dpi=300)