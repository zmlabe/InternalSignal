...
plt.text(2100,0.98,r'\textbf{SOUTHEAST ASIA}',color='dimgrey',fontsize=11,
         ha='right')
...
plt.text(2100,0.98,r'\textbf{INDIA}',color='dimgrey',fontsize=11,
         ha='right')
...
for i,c in zip(range(len(datasets)),color):
    if i == 4:
        plt.plot(years_southern[i],data_southern[i],c=c,linewidth=2.5,zorder=10,
                 label=r'\textbf{%s}' % datasets[i],linestyle='--',
                 dashes=(1,0.6))           
    else:
        plt.plot(years_southern[i],data_southern[i],c=c,linewidth=2.5,zorder=1,
                 label=r'\textbf{%s}' % datasets[i]) 
...
plt.text(2100,0.98,r'\textbf{SOUTHERN OCEAN}',color='dimgrey',fontsize=11,
         ha='right')
...
plt.text(2100,0.98,r'\textbf{NORTH ATLANTIC}',color='dimgrey',fontsize=11,
     ha='right')

plt.tight_layout()
plt.savefig(directoryfigure + 'LRP_timeseries4_v1-1_%s_%s.png' % (seasonforplot,variableforplot),dpi=300)