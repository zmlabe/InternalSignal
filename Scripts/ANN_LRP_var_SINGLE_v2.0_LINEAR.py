"""
Train the model on the different LENS-SINGLE runs for annual data using a
LINEAR model!!!
...
for sis,singlesimulation in enumerate(datasetsingle):
    ...
    for seas in range(len(seasons)):
        ...
        directoryfigure = '/Users/zlabe/Desktop/SINGLE_v2.0/LINEAR/'
        ...
        if rm_ensemble_mean == False:
            if variq == 'U700':
                ...
                if rm_ensemble_mean == True:
                    plt.savefig(directoryfigure + 'MEAN_%s_%s_%s_%s_ENSMEAN-REMOVED_land%s_ocean%s_20ens.png' % (variq,
                                                                                              monthlychoice,
                                                                                              reg_name,
                                                                                              dataset,land_only,ocean_only),dpi=300)
                else:
                    plt.savefig(directoryfigure + 'MEAN_%s_%s_%s_%s_land%s_ocean%s_20ens.png' % (variq,
                                                                                          monthlychoice,
                                                                                          reg_name,
                                                                                          dataset,land_only,ocean_only),dpi=300)
                ...
                if rm_ensemble_mean == True:
                    ...
                    plt.savefig(directoryfigure + 'MEAN_%s_%s_%s_%s_land%s_ocean%s_land%s_ocean%s_20ens.png' % (variq,
                                                                                          monthlychoice,
                                                                                          reg_name,
                                                                                          dataset,land_only,ocean_only),dpi=300)
            elif variq == 'T2M':
