...
plt.xlabel(r'\textbf{Years}',fontsize=10,color='dimgrey')
plt.ylabel(r'\textbf{2-m Temperature Anomalies [$^{\circ}$C]}',fontsize=10,color='dimgrey')
...
plt.savefig(directoryfigure + 'TimeSeries_T2M_XGHG-LENS-20CRv3_R1.png',
            dpi=600)