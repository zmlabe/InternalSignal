...
Method 3 = mean temperature change / mean std of temperature per 3 periods
...
ghg_20meanstd = np.nanstd(ghg_20std,axis=0)
aer_20meanstd = np.nanstd(aer_20std,axis=0)
lens_20meanstd = np.nanstd(lens_20std,axis=0)
...
snr_ghg = meanchange_ghg/meanstd_ghg
snr_aer = meanchange_aer/meanstd_aer
snr_lens = meanchange_lens/meanstd_lens
...
plt.savefig(directoryfigure + 'SNRPeriods_T2M_XGHG-XAER-LENS_Method3.png',dpi=300)