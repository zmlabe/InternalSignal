...
numLats = data.shape[2]
numLons = data.shape[3]     
x = x_perc.reshape(np.shape(summaryDTScaled)[0],numLats,numLons)
...
# ### OI
# # Input your input dimensions here -- this is used to generate an all-zero 
# # input image; we collected this value earlier in our code
# input_dimensions = numLats*numLons  # (lat x lon)
...
# # Calculate OI
# input_img = LRP.optimal_input(model,input_image,target_class,
