...
Method 2 = mean temperature change / spread in ensemble temperature change
...
### Calculate change in temperature from 1920-1959
...
snr_ghg = meanchange_ghg/spread_ghg
snr_aer = meanchange_aer/spread_aer
snr_lens = meanchange_lens/spread_lens
...
plt.savefig(directoryfigure + 'SNRPeriods_T2M_XGHG-XAER-LENS_Method2.png',dpi=300)