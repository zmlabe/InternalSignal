"""
Plots normalized histograms of R^2 of observations using shuffled lat and lon
data ANN
...
plt.savefig(directoryfigure + 'Histogram_r2_SHUFFLE-SPACE_T2M_%s.png' % SAMPLEQ,
            dpi=300)