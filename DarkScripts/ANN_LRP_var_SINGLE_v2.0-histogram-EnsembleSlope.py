...
np.savetxt(directorydataoutput + 'Slopes_1920-1979-TestENS_XGHG-XAER-LENS_%s_RANDOMSEED_20ens.txt' % SAMPLEQ,modelslopes)
np.savetxt(directorydataoutput + 'R2_1920-1979-TestENS_XGHG-XAER-LENS_%s_RANDOMSEED_20ens.txt' % SAMPLEQ,modelr2)