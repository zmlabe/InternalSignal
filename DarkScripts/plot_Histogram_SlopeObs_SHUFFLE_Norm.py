"""
Plots normalized histograms of slope of observations using shuffled data ANN
...
n, bins, patches = plt.hist(slopes,bins=np.arange(-1,1.21,0.1)-0.05,
                                        ...
                                        label=r'\textbf{SHUFFLE DATA ANN}',
...
plt.savefig(directoryfigure + 'Histogram_Slopes_SHUFFLE_T2M_%s_Norm.png' % SAMPLEQ,
            dpi=300)