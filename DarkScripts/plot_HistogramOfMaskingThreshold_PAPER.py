...
for i in range(len(patches_random)):
    ...
    patches_random[i].set_edgecolor('k')
...
plt.xlabel(r'\textbf{DISTRIBUTION OF LRP FOR SHUFFLED DATA [RELEVANCE]}',fontsize=10,color='w')
...
plt.savefig(directoryfigure + 'LRP_MaskingExample_PAPER_DARK.png',dpi=600)